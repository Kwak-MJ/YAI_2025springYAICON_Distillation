...
if __name__ == "__main__":
    ...
    if MODEL_JOB == 'teacher':
        ...
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    elif MODEL_JOB == 'distillation_LDH':
        ### Change here ###
        model = modelWithFeat(resnet18())  # student
        MODEL_NAME = "Distilled_resnet18_LDH"
        ######
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    elif MODEL_JOB == 'distillation_LDH2':
        ### Change here ###
        model = modelWithFeat(resnet18())  # student
        MODEL_NAME = "Distilled_resnet18_LDH2"
        ######
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    elif MODEL_JOB == 'distillation_LDH3':
        ### Change here ###
        model = modelWithFeat(resnet18())  # student
        MODEL_NAME = "Distilled_resnet18_LDH3"
        ######
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    elif MODEL_JOB == 'distillation_LDH4':
        ### Change here ###
        model = modelWithFeat(resnet18())  # student
        ...
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    elif MODEL_JOB == 'distillation_LDH5':
        ### Change here ###
        model = modelWithFeat(resnet18())  # student
        MODEL_NAME = "Distilled_resnet18_LDH5"
        ######
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    elif MODEL_JOB == 'distillation_LDH6':
        ### Change here ###
        model = modelWithFeat(resnet18())  # student
        MODEL_NAME = "Distilled_resnet18_LDH6"
        ######
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    elif MODEL_JOB == 'distillation_LDH10':
        ### Change here ###
        model = modelWithFeat(resnet18())  # student
        MODEL_NAME = "Distilled_resnet18_LDH10"
        ######
        model.load_state_dict(torch.load(ckp_path +
                                         "/{}.pth".format(MODEL_NAME)))
    else:
        raise ValueError(
            "MODEL_JOB can be 'teacher', 'student', or 'distillation'")
