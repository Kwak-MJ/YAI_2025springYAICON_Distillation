...
def train_distillation(teacher, student, alpha=0.7, T=2, epochs=50, learning_rate=0.001, batch_size=256, model_name=None, scheduler_step=20):
    print("================================================")
    print("Train start")
    ...
    for epoch in range(epochs):
        ...
        for x, y in train_loader:
            ...
            loss = epoch/(epochs-1) * student_loss + \
                (1 - epoch/(epochs-1)) * soft_loss
...
if __name__ == "__main__":
    ...
    MODEL_NAME = "Distilled_resnet18_KMJ"
